...
Each posted paper gets a bilingual EN/JA technical note. The English note is
generated by `PAPER_WATCH_SUMMARY_MODEL` as compact `Material / Method /
Physics / New` fields, and the Japanese note is a structure-preserving
