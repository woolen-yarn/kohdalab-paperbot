...
Paper Watch v1 uses a configurable profile-term score, not RAG similarity yet.
...
Each posted paper gets a bilingual EN/JA introduction generated by the local
Ollama model. A later version can add an additional RAG similarity score by
embedding each candidate abstract and comparing it with the lab PDF index.
