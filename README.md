...
Each posted paper gets a bilingual EN/JA technical commentary. The English
commentary is generated by `PAPER_WATCH_SUMMARY_MODEL` as a 100-180 word
researcher-facing explanation covering problem, material/system, method,
physics, novelty, significance, and a short `Relevance to our research`
section. The Japanese note is a structure-preserving translation by
